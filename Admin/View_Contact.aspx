<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/admin_dashboard.Master" AutoEventWireup="true" CodeBehind="View_Contact.aspx.cs" Inherits="Tutor_Managment_System.Admin.View_Contact" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:GridView CssClass="table table-bordered table-hover table-stripped table-dark" ID="GridView1" runat="server" AutoGenerateColumns="False" OnRowDeleting="GridView1_RowDeleting">
        <Columns>
